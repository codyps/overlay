...
inherit base toolchain-funcs cmake-utils git prefix

DESCRIPTION="ROS patched version. The Point Cloud Library (or PCL) is a large scale, open project for 3D point cloud processing."
HOMEPAGE="https://github.com/wg-debs/pcl"
EGIT_REPO_URI="https://github.com/wg-debs/pcl.git"
...
src_configure() {
	...
	mycmakeargs+=( "-DWITH_ROS=ON" )
	mycmakeargs+=( "-DCMAKE_INSTALL_PREFIX=${EPREFIX}/opt/ros/fuerte" )
